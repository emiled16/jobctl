...
- [x] T21: Implement the router node that classifies user intent in `src/jobctl/agent/router.py`
- [x] T22: Implement `chat_node` with streaming LLM responses in `src/jobctl/agent/nodes/chat_node.py`
- [x] T23: Implement `graph_qa_node` with `search_nodes` and vector-search tools in `src/jobctl/agent/nodes/graph_qa_node.py`
...
- [x] T38: Implement `curate_node` in `src/jobctl/agent/nodes/curate_node.py`
- [x] T39: Implement `CurateView` Textual Screen in `src/jobctl/tui/views/curate.py`
- [x] T40: Implement `CurationProposalCard` widget in `src/jobctl/tui/widgets/proposal_card.py`
...
- [x] T48: Update `README.md` to reflect the v2 single-entry TUI
